...
const HERO_SLIDES: HeroSlide[] = [
  ...
  },
  {
    ...
    text: "Розбився градусник? Ми допоможемо безпечно зібрати ртуть. Точна ціна всіх послуг формується після огляду.",
  },
];
            ...
            <div id="formats" className="mb-16 scroll-mt-24">
              ...
              <div className="grid overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-[0_1px_2px_rgba(15,23,42,0.06)] md:grid-cols-3">
                ...
                <article className="bg-zinc-50/60 p-8">
                  ...
                  <p className="mt-3 text-sm leading-relaxed text-slate-600">
                    Випадково розбився градусник? Не намагайтеся зібрати ртуть самостійно! Наші фахівці проводять безпечну демеркуризацію в Києві та області. Надійно збираємо та утилізуємо небезпечний метал.
                  </p>
                  <a
                    href="#contact"
                    className="mt-6 inline-block text-xs font-medium uppercase tracking-wide text-slate-900 underline decoration-slate-400 underline-offset-4 hover:decoration-slate-900"
        ...
        <div className="mx-auto max-w-7xl px-4 py-12 text-sm text-slate-500 sm:px-6 lg:px-8">
          <div className="grid gap-8 md:grid-cols-2 md:gap-12 lg:items-start">
            <div className="flex flex-col gap-6">
              ...
              <a
                href="https://t.me/+380734705827"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Написати в Telegram"
                className="inline-flex w-full max-w-sm items-center justify-center gap-2 rounded-xl bg-[#229ED9] px-4 py-2.5 text-xs font-medium text-white shadow-sm transition hover:bg-[#1c8cc1] focus:outline-none focus:ring-2 focus:ring-[#229ED9] focus:ring-offset-2"
              >
